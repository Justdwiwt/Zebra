    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            for (Map<String, Object> m : list) {
                String app01Name = APP01.getName(((Long) m.get("apptype")).intValue());
                legendBuf.append("'").append(app01Name).append("',");

                int data = ((BigDecimal) m.get("su")).intValue();
                sum += data;
                seriesBuf.append("{value:").append(data).append(", name:'").append(app01Name).append("'},");
            }
